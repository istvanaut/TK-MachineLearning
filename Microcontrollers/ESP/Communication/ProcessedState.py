...
class ProcessedState:
    def __init__(self, **kwargs):
        ...
        # if not kwargs.get('processed_data') and not kwargs.get('query'):
        #     raise ValueError('processed_data or query must be passed as kwargs')
...
# processed_data = [
#     bytearray([100, 200, 250, 150]),
#     bytearray([101, 202, 253, 154]),
#     [12, 12],
#     [24, 24]
# ]
#
# process = ProcessedState(query='state.prev_state.light_sensor == 2533017700')
# print(process.statesList)
# process.saveActualStates()
