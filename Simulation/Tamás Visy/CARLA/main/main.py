...
from settings import ENVIRONMENT_TYPE, EnvironmentTypes, AGENT_TYPE, AgentTypes, NETWORK_AGENT_MODEL_TYPE, TRAIN, \
    TRAIN_PER_DECISION
...
def main():
    ...
    try:
        ...
        normal_main_loop(agent, env, dashboard, statefilters, outputfilters)
