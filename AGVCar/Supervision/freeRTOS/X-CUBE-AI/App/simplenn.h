...
#ifndef AI_SIMPLENN_H
#define AI_SIMPLENN_H
#pragma once
...
/******************************************************************************/
#define AI_SIMPLENN_MODEL_NAME          "simplenn"
#define AI_SIMPLENN_ORIGIN_MODEL_NAME   "mcu_nn"

/******************************************************************************/
#define AI_SIMPLENN_ACTIVATIONS_ALIGNMENT   (4)
 ...
 * @ref ai_simplenn_create. Both the activations memory buffer 
 ...
 * using @ref ai_simplenn_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_SIMPLENN_*
 * defines into file @ref simplenn.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
