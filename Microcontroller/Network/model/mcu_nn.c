...
#define AI_NET_OBJ_INSTANCE g_mcu_nn
 
#undef AI_MCU_NN_MODEL_SIGNATURE
#define AI_MCU_NN_MODEL_SIGNATURE     "164e32791dd83822876da2e8eca7bd09"
...
#define AI_TOOLS_DATE_TIME   "Fri Apr 23 10:43:23 2021"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_MCU_NN_N_BATCHES
#define AI_MCU_NN_N_BATCHES         (1)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 1024, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_MCU_NN_IN_NUM, &image_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_MCU_NN_OUT_NUM, &node_22_output),
  &node_10_layer, 0, NULL)



AI_DECLARE_STATIC
ai_bool mcu_nn_configure_activations(
...
AI_DECLARE_STATIC
ai_bool mcu_nn_configure_weights(
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_MCU_NN_MODEL_NAME,
      .model_signature   = AI_MCU_NN_MODEL_SIGNATURE,
  ...
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= mcu_nn_configure_weights(net_ctx, &params->params);
  ok &= mcu_nn_configure_activations(net_ctx, &params->activations);
...
AI_API_ENTRY
ai_i32 ai_mcu_nn_forward(ai_handle network, const ai_buffer* input)
{
