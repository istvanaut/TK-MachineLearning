...
/******************************************************************************/
#define AI_MCU_NN_MODEL_NAME          "mcu_nn"
#define AI_MCU_NN_ORIGIN_MODEL_NAME   "mcu_nn"

/******************************************************************************/
#define AI_MCU_NN_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_MCU_NN_IN_NUM        (1)
#define AI_MCU_NN_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1024, 1, NULL), \
}
#define AI_MCU_NN_IN_SIZE { \
  AI_MCU_NN_IN_1_SIZE, \
}
#define AI_MCU_NN_IN_SIZE_BYTES { \
  AI_MCU_NN_IN_1_SIZE_BYTES, \
}
#define AI_MCU_NN_IN_1_HEIGHT      (1)
#define AI_MCU_NN_IN_1_WIDTH       (1)
#define AI_MCU_NN_IN_1_CHANNEL     (1024)
#define AI_MCU_NN_IN_1_SIZE        (1 * 1 * 1024)
#define AI_MCU_NN_IN_1_SIZE_BYTES  (AI_MCU_NN_IN_1_SIZE * 4)

/******************************************************************************/
#define AI_MCU_NN_OUT_NUM       (1)
#define AI_MCU_NN_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 4, 1, NULL), \
}
#define AI_MCU_NN_OUT_SIZE { \
  AI_MCU_NN_OUT_1_SIZE, \
}
#define AI_MCU_NN_OUT_SIZE_BYTES { \
  AI_MCU_NN_OUT_1_SIZE_BYTES, \
}
#define AI_MCU_NN_OUT_1_HEIGHT      (1)
#define AI_MCU_NN_OUT_1_WIDTH       (1)
#define AI_MCU_NN_OUT_1_CHANNEL     (4)
#define AI_MCU_NN_OUT_1_SIZE        (1 * 1 * 4)
#define AI_MCU_NN_OUT_1_SIZE_BYTES  (AI_MCU_NN_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_MCU_NN_N_NODES (7)
 ...
 */
AI_API_ENTRY
ai_error ai_mcu_nn_get_error(ai_handle network);
 ...
 * using @ref ai_mcu_nn_get_error
 */
AI_API_ENTRY
ai_bool ai_mcu_nn_init(
 ...
 * header generated by the code generation tool. See AI_MCU_NN_*
 * defines into file @ref mcu_nn.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
